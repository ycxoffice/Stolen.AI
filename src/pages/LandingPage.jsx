        ...
        <section className="px-8 pb-20 max-w-7xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Explore detailed information about leading AI-powered cybersecurity companies
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-sm text-gray-400">Target Customers</p>
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-6">
                    <div className="bg-gray-700/30 rounded-lg p-3">
                      ...
                      <p className={company.threatIntel === "Yes" ? "text-green-400" : "text-gray-300"}>
                        {company.threatIntel}
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-700/30 rounded-lg p-3">
                      ...
                      <p className={company.ransomware === "Yes" ? "text-green-400" : "text-gray-300"}>
                        {company.ransomware}
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-700/30 rounded-lg p-3">
                      ...
                      <p className={company.zeroTrust === "Yes" ? "text-green-400" : "text-gray-300"}>
                        {company.zeroTrust}
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-700/30 rounded-lg p-3">
                      ...
                      <p className={company.blockchain === "Yes" ? "text-green-400" : "text-gray-300"}>
                        {company.blockchain}
                      </p>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                The leading cybersecurity intelligence platform for monitoring AI-powered security solutions.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-blue-400">Partners</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-blue-400">Knowledge Base</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="text-gray-400">123 Security St, San Francisco, CA</li>
              </ul>
            </div>
          </div>
          
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500">© 2025 Stolen.ai. All rights reserved.</p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <a href="#" className="text-gray-500 hover:text-blue-400">Cookies</a>
            </div>
          </div>
        </div>
      </footer>
